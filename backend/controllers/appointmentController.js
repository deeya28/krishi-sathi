...
// @desc    Any logged-in user books an appointment with an expert and gets eSewa payment form data
...
// ==========================================
// VERIFY PAYMENT (eSewa redirect after success)
// ==========================================
...
// ==========================================
// PAYMENT FAILED (eSewa redirect after cancel/failure)
// ==========================================
...
exports.cancelAppointment = async (req, res) => {
  try {
    ...
    const recipient = isFarmer ? appointment.expert : appointment.farmer;
    await createNotification({
      recipient,
      type: "appointment",
